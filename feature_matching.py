...
def sift(input1, input2):
    # Feature detection and mathching
    sift = cv.xfeatures2d.SIFT_create()
    kp1, des1 = sift.detectAndCompute(input1, None)
    kp2, des2 = sift.detectAndCompute(input2, None)
    ...
    # Find homography and remove outliers
    M, mask = cv.findHomography(pts1, pts2, cv.RANSAC, 0.5)
    matchesMask = mask.ravel().tolist()
    pts1 = pts1[matchesMask]
    pts2 = pts2[matchesMask]
    
    return pts1, kp1, des1, pts2, kp2, des2, good, matchesMask, M
...
def nn_match_two_way(desc1, desc2, nn_thresh=0.3):
